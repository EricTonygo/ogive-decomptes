...
class Decompte extends GeneralClass {
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="parent_decompte", referencedColumnName="id")
     * })
     */
    private $parentDecompte;
    
    /**
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="\OGIVE\ProjectBundle\Entity\Decompte", mappedBy="parentDecompte", cascade={"remove", "persist"})
    */
    private $decomptes;
    ...
    */
     ...
     * Set decompte
     *
     * @param \OGIVE\ProjectBundle\Entity\Decompte $parentDecompte
     *
     * @return Decompte
     */
    public function setParentDecompte(\OGIVE\ProjectBundle\Entity\Decompte $parentDecompte=null) {
        $this->parentDecompte = $parentDecompte;
     ...
     */
    public function getParentDecompte() {
        return $this->parentDecompte;
    }
