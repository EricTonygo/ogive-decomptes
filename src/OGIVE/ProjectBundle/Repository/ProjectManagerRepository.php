...
{
    public function deleteProjectManager(\OGIVE\ProjectBundle\Entity\ProjectManager $projectManager) {
        $em= $this->_em;
    ...
    public function saveProjectManager(\OGIVE\ProjectBundle\Entity\ProjectManager $projectManager) {
        $em= $this->_em;
        $projectManager->setStatus(1);
        $em->getConnection()->beginTransaction();
        try{
            $em->persist($projectManager);
            $em->flush();
    ...
    public function updateProjectManager(\OGIVE\ProjectBundle\Entity\ProjectManager $projectManager) {
        $em= $this->_em;
        $em->getConnection()->beginTransaction();
        try{
            $em->persist($projectManager);
    ...
    public function getProjectManagerQueryBuilder() {
         return $this
